...
class ClienteService {
    ...
    private $apiUrlGet    = "http://localhost:8080/Detalles";       
    private $apiUrlPost   = "http://localhost:8080/RegistraC";      
    private $apiUrlPut    = "http://localhost:8080/ActualizarC";  
    private $apiUrlDelete = "http://localhost:8080/EliminarC";     
