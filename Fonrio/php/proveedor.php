...
<body>
  <div class="d-flex" style="min-height: 100vh;">
    ...
    <!-- SIDEBAR (igual que Inicio, con iconos) -->
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
      ...
      <div class="menu-barra-lateral">
        ...
        <hr>
        <div class="seccion-menu">
          <a href="proveedor.php" class="elemento-menu activo">
    ...
    <div class="flex-grow-1">
     <!-- Cabecera -->
<div class="cabecera d-flex align-items-center justify-content-center gap-3">
  <img src="../Imagenes/Logo.webp" alt="Logo TECNICELL" class="logo" />
  <h1 class="titulo m-0">Registro de Proveedores</h1>
</div>
