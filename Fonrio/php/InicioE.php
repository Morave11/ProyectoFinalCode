        ...
        <div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
            ...
            <div class="menu-barra-lateral">
                <div class="seccion-menu">
                    ...
                    <a href="RDevolucion.php" class="elemento-menu"> <!-- Hola falta el link-->
                ...
                <div class="seccion-menu">
                    ...
                    <!-- <a href="#" class="elemento-menu"> Hola falta el link
                        <i class="fas fa-user-friends"></i>
                        <span>Clientes</span>
                    </a>
                    -->
                    <!-- <div href="#" class="elemento-menu">  Hola falta el link
  ...
  <div class="row g-4">
    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card tarjeta-dashboard azul h-100 text-center">
        ...
        <div class="card-body py-2">
          <div class="titulo-tarjeta-dashboard">Órdenes de Compra</div>
    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card tarjeta-dashboard verde-azul h-100 text-center">
        ...
        <div class="card-body py-2">
          <div class="titulo-tarjeta-dashboard">Compras Recibidas</div>
    ...
    <!-- Usuarios -->
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card tarjeta-dashboard rosa h-100 text-center">
        <div class="icono-tarjeta-dashboard mx-auto mt-3 mb-2">
          <i class="fas fa-user-friends"></i>
        </div>
        <div class="card-body py-2">
