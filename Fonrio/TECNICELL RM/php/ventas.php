...
<head>
    ...
    <!-- Estilos del sidebar unificado (mismo que Compras/Inicio) -->
...
<body>
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
      ...
      <div class="menu-barra-lateral">
        <div class="seccion-menu">
          ...
          <a href="ventas.php" class="elemento-menu activo">
  ...
  <!-- Importante: eliminé el script de redirección a InicioA.php que ocultaba la página -->
</body>
</html>
<?php $conexion->close(); ?>
