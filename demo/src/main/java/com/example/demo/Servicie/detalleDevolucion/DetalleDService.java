...
public class DetalleDService {
    ...
    public List<String> obtenerDetalleD() {
        String DevolucionC = "SELECT ID_Devolucion,Cantidad_Devuelta,ID_Venta FROM detalle_devoluciones";
    ...
    public int actualizarDetalleD(String ID_Devolucion, int Cantidad_Devuelta, String ID_Venta) {

        String sql = "UPDATE detalle_devoluciones SET Cantidad_Devuelta = ?, ID_Venta = ? WHERE ID_Devolucion = ?";

        return jdbcTemplate.update(sql, Cantidad_Devuelta, ID_Venta, ID_Devolucion);
    }
